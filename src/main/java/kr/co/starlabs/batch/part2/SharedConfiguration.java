    ...
    public Step shareStep() {
        return stepBuilderFactory.get("shareStep")
                .tasklet((contribution, chunkContext) -> {
                    ...
                    ExecutionContext jonExecutionContext = jobExecution.getExecutionContext();
                    jonExecutionContext.putString("jobKey", "job execution context");
        ...
        return stepBuilderFactory.get("shareStep2")
                .tasklet((contribution, chunkContext) -> {
                    ...
                    log.info("jobKey : [ {} ], stepKey : [ {} ]",
                            jobExecutionContext.getString("jobKey", "emptyJobKdy"),
